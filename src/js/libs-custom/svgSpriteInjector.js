// customized version of - https://github.com/TrySound/svg-sprite-injector/blob/master/svg-sprite-injector.js
// which is inspired by https://osvaldas.info/caching-svg-sprite-in-localstorage
// because https://stackoverflow.com/a/24820654
...
(function(window, document) {
	...
	function injectData(data) {
      ...
      // fix problems with gradients when using icon from svg sprite
      // https://stackoverflow.com/a/24820654
      body.firstChild.setAttribute('style', 'visibility: hidden; position: absolute; width: 0; height: 0;');
		}
	}
